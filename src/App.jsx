...
function App() {
  ...
  const [shoppingLists, setShoppingLists] = useState(
    [{ name: "Cena Familiar", products: [2, 4, 26, 27, 14, 31, 34, 28, 38, 33, 23, 20, 21] },
    { name: "Compra Semanal", products: [3, 36, 37, 38, 24, 25, 29, 35, 11, 8] }]
  );
  ...
  const [shoppings, setShoppings] = useState([{
    ...
    map: [[new ShopTile(TILE_TYPE.AISLE, 0, 0), new ShopTile(TILE_TYPE.AISLE, 0, 1), new ShopTile(TILE_TYPE.AISLE, 0, 2)],
    [new ShelfTile(1, 0, "Carnicería", [4, 5, 6, 7]), new ShopTile(TILE_TYPE.AISLE, 1, 1), new ShelfTile(1, 2, "Lácteos-1", [1, 12, 16])],
    [new ShopTile(TILE_TYPE.REG, 2, 0), new ShopTile(TILE_TYPE.AISLE, 2, 1), new ShelfTile(2, 2, "Lácteos-2", [18, 19])]]
  }]);
